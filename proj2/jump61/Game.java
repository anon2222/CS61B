...
class Game extends Observable {
    ...
    private void setAuto(Side color) {
        switch (color) {
        case RED:
            _players[0] = new AI(this, color);
            break;
        case BLUE:
            _players[1] = new AI(this, color);
            break;
        default:
            return;
        }
    ...
    private void setManual(Side color) {
        switch (color) {
        case RED:
            _players[0] = new HumanPlayer(this, color);
            break;
        case BLUE:
            _players[1] = new HumanPlayer(this, color);
            break;
        default:
            break;
        }
    ...
    private void printBoard() {
        _out.print(_board.toDisplayString());
    }
    ...
    private void readExecuteCommand() {
        try {
            ...
            String input = _inp.next();
            executeCommand(input);
            _inp.nextLine();
        } catch (InputMismatchException e) {
            throw error("InputMismatch");
        }
    }
